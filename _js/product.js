new Vue({
  ...
  methods: {
    fetchCloudinaryData() {
      axios
        .get("server/PRODUCTS.php?COMMAND=GET_PRODUCT") // Replace with your API endpoint
        .then((response) => {
    ...
    initMap1() {
      ...
      const location = { lat: this.userLocation.lat, lng: this.userLocation.lng }; // Example: San Francisco, CA
      const location1 = { lat: this.storeLocation.lat, lng: this.storeLocation.lng }; // Example: San Francisco, CA
